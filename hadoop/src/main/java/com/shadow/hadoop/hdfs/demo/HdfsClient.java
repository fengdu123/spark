package com.shadow.hadoop.hdfs.demo;
...
public class HdfsClient {
    ...
    //hdfs dfs -rm -r hdfs://master:9000/*
...
//		System.out.println(conf.get("fs.default.name"));
    ...
    public void checkFileExist() throws Exception {
        String pathuri = "hdfs://master:9000/demo";
        Path path = new Path(pathuri);
        System.out.println(pathuri + " exist :" + fs.exists(path));
        pathuri = "hdfs://master:9000/temp";
