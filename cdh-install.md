...
## 免密登入
ssh 
echo '192.168.70.1 spafka' >> /etc/hosts 
echo '192.168.70.3  spafka01' >> /etc/hosts
echo '192.168.70.4  spafka02' >> /etc/hosts
echo '192.168.70.5  spafka03' >> /etc/hosts
...
restrict 192.168.70.0 mask 255.255.255.0 notrap nomodify  //给于局域网机的机器有同步时间的权限
